...
Map[String, Boolean] GenomeSpecific = {
...
Map[String, Boolean] LowComplexity = {
...
Map[String, Boolean] Mappability = {
...
Map[String, Boolean] OtherDifficult = {
...
Map[String, Boolean] SegmentalDuplications = {
