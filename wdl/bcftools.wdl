	...
	input {
	 ...
	 output {
       ...
       source:
 		...
 		command {
							bcftools view -O z -V snps -i 'FMT/BVT="INDEL" & FMT/BD="TP"' ~{codingExons_annotated_vcf_gz} > ~{codingExons_annotated_TPonly_vcf_gz};
							bcftools view -O z -V snps -i 'FMT/BVT="INDEL" & FMT/BD="FP"' ~{codingExons_annotated_vcf_gz} > ~{codingExons_annotated_FPonly_vcf_gz};
							bcftools view -O z -V snps -i 'FMT/BVT="INDEL" & FMT/BD="FN"' ~{codingExons_annotated_vcf_gz} > ~{codingExons_annotated_FNonly_vcf_gz};
		}
    runtime {
